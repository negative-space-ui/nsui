...
const NotificationButton = () => {
  ...
  return (
    <Button
      classNames={{
        root: 'cursor-pointer bg-neutral-300 border border-neutral-400/50 px-2 py-1 rounded-md active:scale-97'
      }}
      onClick={() =>
        notification.success({
          heading: 'Title',
          description: 'Description',
          contentProps: { gap: '0.5rem', alignItems: 'center' }
        })
      }
    >
      Show
      ...
      onClick={() => {
        const toast = notification.info({
          ...
          classNames: {
            ...
            content: { root: 'pr-2 py-1', icon: 'w-10 h-10 text-blue-200 fill-blue-600' }
          }
        })
    ...
    variants={{
      success: {
        classNames: {
          ...
          content: { root: 'pr-2 py-1', icon: 'w-10 h-10 text-green-200 fill-green-600' },
    ...
    variants={{
      ...
      error: {
        classNames: {
          ...
          content: { root: 'pr-2 py-1', icon: 'w-10 h-10 text-red-200 fill-red-600' },
